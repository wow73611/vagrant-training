...
This will place a Vagrantfile in your current directory. You can take a look at the Vagrantfile if you want.

The Vagrantfile is filled with comments and examples, such as:
```
# -*- mode: ruby -*-
# vi: set ft=ruby :
...
### Create a Vagrantfile and specify a Box:

$ vagrant init ubuntu/xenial64

The Vagrantfile will change content to the following:
```bash
Vagrant.configure("2") do |config|
